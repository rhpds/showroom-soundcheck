...
down_revision: str | Sequence[str] | None = "650f970b9d23"
...
def upgrade() -> None:
    ...
    op.add_column(
        "showrooms",
        sa.Column("health_check_url", sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    )
    op.add_column(
        "showrooms",
    ...
    op.add_column(
        "showrooms",
        sa.Column("babylon_managed", sa.Boolean(), nullable=False, server_default="false"),
    )
